...
I'm a highly driven AI & ML undergraduate with a knack for turning complex ideas into practical, user-friendly applications. My projects span across machine learning, deep learning, web design, and real-time computer vision systems. I aim to continuously grow by exploring new technologies and contributing to meaningful innovations.
...
**ML & AI Libraries:**
`Scikit-learn`, `TensorFlow`, `Keras`, `OpenCV`, `Pandas`, `NumPy`, `Matplotlib`

**Web Technologies:**
`HTML5`, `CSS3`, `JavaScript`, `Bootstrap`, `Flexbox`, `Grid`, `Responsive Design`

**Tools & Others:**
`Git`, `VS Code`, `MySQL`, `Jupyter`, `PyPDF2`, `NLTK`
...
* Gesture-based controls for drawing, color selection, erasing, and shape recognition
* Sign-based object drawing system using hand gestures
* Smoothing and stabilization with EMA filters for precise stroke rendering
...
### 📺 [YouTube Homepage Clone](https://github.com/SriVarshitha-Sriperambudur/youtube-homepage-clone)

**UI perfection, pixel by pixel.**

* Responsive YouTube homepage built with **HTML5 & CSS3**
* Implemented sticky navbars, sidebar navigation, video grid layout
* CSS effects like hover transitions for realistic YouTube experience
...
* REST APIs & Flask for ML model deployment
* YOLO-based object detection in real-time
* Cloud services like AWS and Heroku
